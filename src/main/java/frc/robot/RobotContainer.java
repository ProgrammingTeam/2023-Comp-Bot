...
//  public static Boolean slowMode = false;
 ...
 // private final SequentialCommandGroup m_autonomousCommand = new Autonomous(m_elevator);
 // private final SequentialCommandGroup m_autonomousDrive = new Autonomous();
  ...
  public RobotContainer() {
    ...
    m_DriveTrain.setDefaultCommand(new DriveCommand(m_DriveTrain, () -> -m_joysL.getRawAxis(1), () -> -m_joysR.getRawAxis(0)));
    configureBindings();
